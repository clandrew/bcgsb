...
70 DIM T$(120): FOR I=1 TO 10: PRINT: NEXT
100 FOR J=0 TO INT(60/L)
110 FOR I=1 TO L
120 T$(J*L+I)=MID$(A$,I,1)
130 NEXT: NEXT
140 C=0
200 A1=1: P=1: C=C+1: IF C=37 THEN GOTO 999
205 PRINT
210 READ A: A1=A1+A: IF P=1 THEN GOTO 300
240 FOR I=1 TO A: PRINT " ";: NEXT: P=1: GOTO 400
300 FOR I=A1-A TO A1-1: PRINT T$(I);: NEXT: P=0
...
999 FOR I=1 TO 10: PRINT: NEXT: END
